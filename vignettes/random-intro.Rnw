...
%% shortcuts
\newcommand{\randomorg}{\href{https://www.random.org}{random.org}}
...
\author{\href{https://dirk.eddelbuettel.com}{Dirk Eddelbuettel}}
\date{August 2006}
...
\pkg{rstream} \citep{rstream:2006}. The CRAN Task Views \citep{ctv2025} for
Distributions \citep{ctvDistributions} and High-Performance Computing
\citep{ctvHPC} contain additional resources.
